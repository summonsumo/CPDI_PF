    ...
    function() 
        ...
        if textNum == 1 then
            button:addEventListener("tap", function ()
                texts(group,"Xavier","Fico feliz que tenha gostado, Hannah.\nUma curiosidade: você já ouviu falar\nno sangue dourado?",2)
                ...
                audio.dispose(han1)
                han1 = nil
                local xav1 = audio.loadSound( "Assets/Xav1-2.mp4" )
                audio.play(xav1,{fadein = 500, channel = 4})
                end)
            elseif textNum == 2 then
                button:addEventListener("tap", function ()
                    texts(group,"Hannah","Sangue dourado? Não, nunca ouvi falar.",3)
                    display.remove(button)
                    display.remove(text1)
                    display.remove(nameCheck)
                    display.remove(slider)
                    ...
                    audio.dispose(xav1)
                    xav1 = nil
                    local han2 = audio.loadSound( "Assets/Han2-2.mp4" )
                    audio.play(han2,{fadein = 500, channel = 4})
                    end)
            elseif textNum == 3 then
                button:addEventListener("tap", function ()
                    texts(group,"Xavier",'O sangue dourado possui RH nulo.',4)
                    display.remove(button)
                    display.remove(text1)
                    display.remove(nameCheck)
                    display.remove(slider)
                    ...
                    audio.dispose(han2)
                    han2 = nil
                    local xav2 = audio.loadSound( "Assets/Xav2-2.mp4" )
                    audio.play(xav2,{fadein = 500, channel = 4})
                    end)
            elseif textNum == 4 then
                button:addEventListener("tap", function ()
                    texts(group,"Hannah",'Fiquei curiosa! Vou pesquisar mais sobre\no assunto. Até amanhã, professor!',5)
                    display.remove(button)
                    display.remove(text1)
                    display.remove(nameCheck)
                    display.remove(slider)
                    ...
                    audio.dispose(xav2)
                    xav2 = nil
                    local han3 = audio.loadSound( "Assets/Han3-2.mp4" )
                    audio.play(han3,{fadein = 500, channel = 4})
                    end)
            elseif textNum == 5 then
                button:addEventListener("tap", function ()
                    texts(group,"Xavier",'Até amanhã, Hannah!',6)
                    display.remove(button)
                    display.remove(text1)
                    display.remove(nameCheck)
                    display.remove(slider)
                    ...
                    audio.dispose(han3)
                    han3 = nil
                    local xav3 = audio.loadSound( "Assets/Xav3-2.mp4" )
                    audio.play(xav3,{fadein = 500, channel = 5})
                    end)
...
local function cutsceneTexts(group)
    ...
    texts(group,"Hannah","Ah, professor, esse jogo é muito legal!",1)
    local han1 = audio.loadSound( "Assets/Han1-2.mp4" )
...
function scene:create( event )
    ...
    bg:setFillColor(205/255,215/255,0/255)
    bg:toBack()
